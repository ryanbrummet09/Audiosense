...
while(ischar(charArray))
    ...
    if str2double(charArray(1,21)) == 1
        extractedData(index,1) = str2double(charArray(1,1));
        extractedData(index,2) = str2double(charArray(1,6));
        extractedData(index,3) = str2double(charArray(1,7));
        extractedData(index,4) = str2double(charArray(1,8));
        extractedData(index,5) = str2double(charArray(1,9));
        extractedData(index,6) = str2double(charArray(1,10));
        extractedData(index,7) = str2double(charArray(1,11));
        extractedData(index,8) = str2double(charArray(1,12));
        extractedData(index,9) = str2double(charArray(1,13));
        extractedData(index,10) = str2double(charArray(1,14));
        extractedData(index,11) = str2double(charArray(1,15));
        extractedData(index,12) = str2double(charArray(1,26));
        temp = (charArray(1,30));
        temp = temp{1};
        if temp(1,26) == '/'
            extractedData(index,13) = str2double(temp(1,25));
        elseif size(temp,2) > 80
            extractedData(index,13) = str2double(temp(1,[24:25]));
        else
            extractedData(index,13) = str2double(temp(1,[25:26]));
        end
        %here
        if str2double(charArray(1,16)) ~= 50
            extractedData(index,14) = str2double(charArray(1,16));
        else
            extractedData(index,14) = NaN;
        end
        if str2double(charArray(1,17)) ~= 50
            extractedData(index,15) = str2double(charArray(1,17));
        else
            extractedData(index,15) = NaN;
        end
        if str2double(charArray(1,18)) ~= 50
            extractedData(index,16) = str2double(charArray(1,18));
        else
            extractedData(index,16) = NaN;
        end
        if str2double(charArray(1,19)) ~= 50
            extractedData(index,17) = str2double(charArray(1,19));
        else
            extractedData(index,17) = NaN;
        end
        if str2double(charArray(1,20)) ~= 50
            extractedData(index,18) = str2double(charArray(1,20));
        else
            extractedData(index,18) = NaN;
        end
        if str2double(charArray(1,23)) ~= 50
            extractedData(index,19) = str2double(charArray(1,23));
        else
            extractedData(index,19) = NaN;
        end
        if str2double(charArray(1,24)) ~= 50
            extractedData(index,20) = str2double(charArray(1,24));
        else
            extractedData(index,20) = NaN;
        end
        if str2double(charArray(1,25)) ~= 50
            extractedData(index,21) = str2double(charArray(1,25));
        else
            extractedData(index,21) = NaN;
        end
        if str2double(charArray(1,27)) ~= 50
            extractedData(index,22) = str2double(charArray(1,27));
        else
