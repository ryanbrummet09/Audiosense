...
processedDataLocation = 'Users/ryanbrummet/Documents/MATLAB/Audiology/AudioStuff/responseSets/le.mat';
...
for k = 1 : size(dataTable,1)
    ...
    var(isinf(var)) = NaN;
    var = nanmean(var(:,audioFeatureIndexes));   % modify this line to change audio predictors being used
    audioData(k,:) = var;
end
