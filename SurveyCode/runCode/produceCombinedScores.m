...
makeGraphs = true;
outputVarFileName = 'compositeScoreOn_ap_UsingSUMUserNorm'; %can be NoNorm, GlobalNorm, or UserNorm
dataFileName = 'DataTable.mat';  %must be .mat file, variable must be 'unProcessedData'
mapInfoFileName = '/Users/ryanbrummet/Documents/MATLAB/Audiology/robustMappingGraphs/userNormalized/mapCoefVar.mat'; 
removeFifties = true;
omitListening = false;
...
targetAttr = 'ap';
combineScoreTechnique = 2; %1 for avg, 2 for sum, 3 for median, 4 for std, %MIN DOES NOT WORK SO IT IS LIKELY THAT MAX DOESN'T AS WELL
saveLocation = {'/Users/ryanbrummet/Documents/MATLAB/Audiology/robustMappingGraphs/userNormalized/combinedScoreUsingSUMap/'};
