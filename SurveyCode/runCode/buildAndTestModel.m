...
if useDemoData
    save(char(strcat('Results/','CSR_',modelTech,'_',target,'_',norm,'_',combinedTech,'_DemoTRUE')));
    if sendEmail
        sendGmail('ryanbrummet09@augustana.edu',char(strcat(modelTech,'_',combineTach,'_',normTech,'_',useDemoData,'_',target)),'',char(strcat('Results/','CSR_',modelTech,'_',target,'_',norm,'_',combinedTech,'_DemoTRUE')));
    end
else
    save(char(strcat('Results/','CSR_',modelTech,'_',target,'_',norm,'_',combinedTech,'_DemoFALSE')));
    if sendEmail
        sendGmail('ryanbrummet09@augustana.edu',char(strcat(modelTech,'_',combineTach,'_',normTech,'_',useDemoData,'_',target)),'',char(strcat('Results/','CSR_',modelTech,'_',target,'_',norm,'_',combinedTech,'_DemoFALSE')));
    end
end
