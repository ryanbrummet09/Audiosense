...
robustFit = false; %if false, poly fit is used to find best mapping per 
...
savePathWtName = {'/Users/ryanbrummet/Documents/MATLAB/Audiology/PolyMappingGraphs'};  %can be robustMappingGraphs, polyMappingGraphs, robustMappingGraphsWtOut_________(list attr), or polyMappingGraphsWtOut______(list attr)
