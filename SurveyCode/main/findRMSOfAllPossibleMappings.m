...
%       meanSingleRMS, medianSingleRMS, meanCRMS, medianCRMS
                    ...
                    for sample = 1 : 1
                        for target = 1 : 9
                            ...
                            for deg = 1 : 5
                                ...
                                [ extractedData, attrMapTarget ] = pickAttrs( Data, [1,1,1,1,1,1,0,0,1], target);
    ...
    for k = 1 : size(RMSValsTemp,1)
        ...
        RMSVals(k,14) = mean(RMSValsTemp(k,14,1:repeat));
    end
